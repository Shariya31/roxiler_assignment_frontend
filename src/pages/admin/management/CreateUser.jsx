...
const CreateUser = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            setError(null);
            setSuccess(null);
            const response = await axios.post(`${server}/api/user/create-user`, data, {
                headers: {
        ...
        <div className='h-screen flex'>
            ...
            <div className='flex-3 flex items-start pt-6 justify-center'>
                <form className='h-[80%] w-[50%] flex flex-col pt-8 items-center justify-start shadow-[13px_16px_28px_0px_rgba(0,_0,_0,_0.1)]' action="" onSubmit={handleSubmit(onSubmit)}>
                    <h2 className='text-center mx-auto text-3xl'>Create User</h2>
                    ...
                    <div>
                        <label className='mr-8' htmlFor="">Role</label>
                        <input
                            className='mt-4 mb-2 border-2 border-gray-700 rounded-md'
                            type="text"
                            {...register("role")}
                    ...
                    <div>
                        <label className='mr-8' htmlFor="">Password</label>
                        <input
                            className='mt-4 mb-2 border-2 border-gray-700 rounded-md'
                            type="text"
                            {...register("password")}
