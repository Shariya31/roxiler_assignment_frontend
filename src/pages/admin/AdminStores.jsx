        ...
        <div className='h-screen relative flex gap-8'>
            ...
            <div className='w-full h-full flex flex-col justify-around pt-4 flex-3 shadow-[13px_16px_28px_0px_rgba(0,_0,_0,_0.1)]'>
                <div className='flex justify-around p-8'>
                    ...
                    <Link className='p-3 border-2 border-black rounded-md font-bold hover:bg-black hover:text-white ease-in-out duration-500' to='/admin/create-store'>Add Store</Link>
